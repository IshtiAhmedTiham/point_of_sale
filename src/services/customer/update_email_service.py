...
def send_customer_email_for_update(customer):
    with open("src/template/customer/update_customer_mail.html", "r") as file:
        body = file.read()
    ...
    updated_at = customer.updated_at.strftime("%d %B %Y, %I:%M %p")
